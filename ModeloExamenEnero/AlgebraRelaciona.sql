...
-- 2) Determinar el nombre de los lientes que viven en OAXACA
...
-- 5) Todos los clientes que tienen un prestamo y una cuenta abierta
		-- Por Interseccion de cojuntos
...
-- 6) Nombre de todos los clientes que tienen un credito en la sucursal TULUM
		-- Primera forma:
...
-- 7) Nombre de todos los clientes que tienen un prestamo y el importe del mismo
		-- Forma facil con NATURAL JOIN
